...
function fields_and_options() {
	...
	Block::make( 'Hero section' )
	     ...
	     ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
             ...
             <div style="color:<?= esc_html( $fields['hero_pre_title_dop1_color'])  ?>" class="site-hero__title_dop1"><img style="margin-right: 15px" src="<?= $fields['hero_pre_title_dop1_icon'] ?>" alt=""><?= esc_html( $fields['hero_pre_title_dop1'])  ?></div>
             <? endif; ?>
				     <h1 class="site-hero__title" style="color:<?= esc_html( $fields['hero_title_color'])  ?>"><span style="color:<?= esc_html( $fields['hero_pre_title_color'])  ?>" class="site-hero__pre-title"><?= $fields['hero_pre_title'] ?></span><br><?= $fields['hero_title']  ?></h1>
				     <div style="color:<?= esc_html( $fields['hero_desc_color'])  ?>" class="site-hero__desc"><?= esc_html( $fields['hero_desc'])  ?></div>
					     ...
					     <div class="swiper-wrapper">
							 ...
							 ?>
							     <div class="swiper-slide site-hero__slide">
                                     ...
                                     ?>
								     <img width="1050" height="700" alt="img"  class="h__img" src="<?= $slide_image ?>">
                                     <?
                                     $image_resize_url = ImageResizeWordPress::resizeWidthWebp($hero_slide_img, 768);
                                     ?>
                                     <img width="768" height="400" alt="img" class="h__img h__img_mobile" src="<?= $image_resize_url ?>" >
									 <?
									 }
			...
			<div style="color:<?= esc_html( $fields['hero_desc_color'])  ?>" class="site-hero__desc"><?= esc_html( $fields['hero_desc'])  ?></div>
				...
				<div class="container">
				    <div class="hero__sides-wrapper">
    				    <div class="hero__left-side">
                            ...
                            <div class="speakers-info">
                                <img width="70" height="70" class="speakers-info__img" src="http://korove3w.beget.tech/wp-content/uploads/2023/06/speaker-photo.png" alt="">
                                <img width="70" height="70" class="speakers-info__img" src="http://korove3w.beget.tech/wp-content/uploads/2023/06/speaker-photo.png" alt="">
                                <img width="70" height="70" class="speakers-info__img" src="http://korove3w.beget.tech/wp-content/uploads/2023/06/speaker-photo.png" alt="">
                        ...
                        <div class="hero__right-side">
                            <form data-succsess-text="<?= $contact_form_success_msg3 ?>" data-error-text="<?= $contact_form_error_msg3 ?>" class="contact-form-block__form gform">
                                <div class="contact-form-block__full-width">
                                    <input type="text" name="first-name" placeholder="<?= $fields['hero_contact_form_first_name'] ?>" pattern="[^0-9]+" required autocomplete="off">
                                    <input type="email" name="email" placeholder="<?= $fields['hero_contact_form_email'] ?>" required autocomplete="off">
                                    <input type="tel" class="phone" name="phone" required autocomplete="off">
                                    <input type="text" name="company-name" placeholder="<?= $fields['hero_contact_form_company_name'] ?>" required autocomplete="off">
                                    <? if(!empty($fields['hero_contact_form_select_options'])): ?>
                                    <select name="type" required>
                                        <option disabled selected><?= $fields['hero_contact_form_select'] ?></option>
                   ...
                   <input type="hidden" name="utm_term" value="<?= $_GET['utm_term'] ?>">
                                ...
                                <div class="contact-form-block_policy" id="form1_checkbox"><input class="contact-form-block_policy_checkbox" type="checkbox" checked="checked" name="form_checkbox" aria-labelledby="form1_checkbox"><?= $fields['hero_contact_form_privacy_policy'] ?></div>
                                <button class="site-btn contact-form-block__form-btn <?=$GLOBALS['btn_post_class_random']?>" type="submit"><?= $fields['hero_contact_form_button_text'] ?></button>
...
spanElements.forEach(function(span) {
    ...
    if (currentClass.length > 5) {
        ...
        span.className = '';
					...
					<h1 class="site-hero__title" style="color:<?= esc_html( $fields['upload_hero_title_color'])  ?>"><?= $fields['upload_hero_title']  ?></h1>
				    <div class="hero__sides-wrapper hero__sides-wrapper--upload-hero">
    				    <div class="hero__left-side">
    				        ...
    				        <a href="<?= $upload_hero_btn_link ?>"><img src="<?= wp_get_attachment_image_url( $upload_hero_image, 'full' ) ?>" alt="<?php echo $imgAlt ?>"></a>
    				        <? endif; ?>
    				    ...
    				    <div class="hero__right-side-desc">
                            <div class="hero-upload-examples">
                                ...
                                <div class="hero-upload-examples__images">
                                    ...
                                    <a href="<?= $upload_hero_btn_link ?>"><img src="<?= wp_get_attachment_image_url($example['image']) ?>" alt=""></a>
                                    <? endforeach ?>
                                </div>
                                <? endif; ?>
                            </div>
			     ...
			     <div class="block partners-logos-block">
				     <div class="partners-group">
						...
						<?  foreach($fields['partners'] as $item): ?>
							<div class="slide"><img alt="img" width="100" height="100" src="<?= $item['logo']?>" ></div>
						<? endforeach; ?>
						</div>
				     </div>
			     </div>
			     ...
			     <div class="container">
				     ...
				     <? if($title_type === 'with-icon-on-top'): ?>
					     ...
					     <? if(!empty($image) and !empty($title)) ?>
					         ...
					         <h2 class="site-section__title site-section__title--centered" style="color:<?= $title_color ?>"><?= $title ?></h2>
				     <? endif; ?>
				     <? if($title_type === 'without-icon'): ?>
					     ...
					     ?>
					     <? if(!empty($title)) ?>
						     <h2 style="color:<?= $title_color ?>; max-width: <?= $title_max_width ?>;" class="site-section__title site-section__title--<?= $title_align ?>"><?= $title ?></h2>
				     <? endif; ?>
				     <? if($show_desc === 'yes'): ?>
					     <?
					     ...
					     <? if(!empty($desc)): ?>
						     ...
						     ?>
						     <div class="site-section__desc site-section__desc--centered" style="color:<?= $fields['site_section_desc_color'] ?>;"><?= $desc ?></div>
					     <? endif; ?>
				     <? endif; ?>
			     </div>
			     <?= $inner_blocks ?>
					     ...
					     <div itemscope itemtype="https://schema.org/HowTo" class="swiper-wrapper banners-block">
						     <? $i=0;foreach($banners as $banner): ?>
							     ...
							     <? if($banner['_type'] === 'type-1'):
                                     ...
                                     ?>
								     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-1 swiper-slide" >
                                         <style>
                                             .<?=$btn_class_random?>{
                                             <?=($banner['btn_text_color']) ? 'color:'.$banner['btn_text_color'].' !important;' : '' ?>
                                             <?=($banner['btn_background_color']) ? 'background:'.$banner['btn_background_color'].' !important;' : '' ?>
                                             <?=($banner['btn_border_color']) ? 'border-color: '.$banner['btn_border_color'].' !important;' : '' ?>
                                             }
                                             .<?=$btn_class_random?>:hover{
                                             <?=($banner['btn_hover_text_color']) ? 'color:'.$banner['btn_hover_text_color'].' !important;' : '' ?>
                                             <?=($banner['btn_hover_background_color']) ? 'background:'.$banner['btn_hover_background_color'].' !important;' : '' ?>
                                             <?=($banner['btn_hover_border_color']) ? 'border-color: '.$banner['btn_hover_border_color'].' !important;' : '' ?>
                                             }
                                         </style>
									     <div class="banner-type-1__content-wrapper">
										     <div style="color: <?=  $banner['pre_title_color']?>" class="banner-type-1__label banner__label"><?= $banner['pre_title']?></div>
										     <div style="color: <?=  $banner['title_color']?>" class="banner-type-1__title"><?= $banner['title'] ?></div>
										     <div style="color: <?=  $banner['desc_color']?>" class="banner-type-1__desc"><?= $banner['desc'] ?></div>
                                            <? if($banner['btn_text']){ ?>
										     <a target="_blank" class="site-btn banner-type-1__btn <?=$btn_class_random?>" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
                                            <? } ?>
									     </div>
                                 ...
                                 <? if($banner['_type'] === 'type-1-1'):
                                     $btn_class_random = $banner['_type'].'_btn_'.uniqid();
                                     ?>
                                     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-1 banner-type-1-1 swiper-slide" itemprop="step" itemscope itemtype="https://schema.org/HowToSection">
                                         ...
                                         <div class="banner-type-1__content-wrapper">
                                             <div style="color: <?=  $banner['pre_title_color']?>" class="banner-type-1__label banner__label"><?= $banner['pre_title']?></div>
                                             <div style="color: <?=  $banner['title_color']?>" class="banner-type-1__title" itemprop="name"><?= $banner['title'] ?></div>
                                             <div style="color: <?=  $banner['desc_color']?>" class="banner-type-1__desc"  itemprop="text"><?= $banner['desc'] ?></div>
                                             <div style="color: <?=  $banner['desc2_color']?>" class="banner-type-1__desc2"  itemprop="text"><?= $banner['desc2'] ?></div>
                                             <? if($banner['btn_text']){ ?>
                                                 <a itemprop="url" target="_blank" class="site-btn banner-type-1__btn <?=$btn_class_random?>" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
                                             <? } ?>
                                         </div>
                                         <? if( !empty($banner['image_link']) ){ ?>
                                             <a class="banner-type-1__img_link" href="<?=$banner['image_link'] . get_params_string() ?>">
                                                 <img alt="img" itemprop="image"  class="banner-type-1__img" src="<?= $banner['image']  ?>">
                                             </a>
                                         <? } else { ?>
                                             <img alt="img"  itemprop="image"  class="banner-type-1__img" src="<?= $banner['image']  ?>">
                                         <? } ?>
                                 ...
                                 <? if($banner['_type'] === 'type-1-2'): ?>
                                     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-1 banner-type-1-2 swiper-slide" itemprop="step" itemscope itemtype="https://schema.org/HowToSection">
                                         <meta itemprop="position" content="<?=$i;?>"/>
                                         <div class="banner-type-1__content-wrapper">
                                             <div style="color: <?=  $banner['pre_title_color']?>" class="banner-type-1__label banner__label"><?= $banner['pre_title']?></div>
                                             <div style="color: <?=  $banner['title_color']?>" class="banner-type-1__title" itemprop="name"><?= $banner['title'] ?></div>
                                             ...
                                             <div style="color: <?=  $banner['desc2_color']?>" class="banner-type-1__desc2"  itemprop="text"><?= $banner['desc2'] ?></div>
                                             <? if($banner['btn_text']){ ?>
                                                 <a target="_blank" itemprop="url" style="background: <?=  $banner['btn_background_color']?>; color: <?=  $banner['btn_text_color']?>; border-color: <?=  $banner['btn_text_color']?>" class="site-btn banner-type-1__btn" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
                                             <? } ?>
                                         </div>
                                         <img alt="img" itemprop="image"  class="banner-type-1__img" src="<?= $banner['image']  ?>">
                                     </div>
                                 ...
                                 <? if($banner['_type'] === 'type-1-3'):
                                     $btn_class_random = $banner['_type'].'_btn_'.uniqid();
                                     ?>
                                     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-1 banner-type-1-3 swiper-slide">
                                         <style>
                                             .<?=$btn_class_random?>{
                                             <?=($banner['btn_text_color']) ? 'color:'.$banner['btn_text_color'].' !important;' : '' ?>
                                             <?=($banner['btn_background_color']) ? 'background:'.$banner['btn_background_color'].' !important;' : '' ?>
                                         ...
                                         <div class="banner-type-1__content-wrapper" style="<?=(!empty($banner['text_margin_bottom']))? '    margin-bottom: '.$banner['text_margin_bottom'].'px;' : '' ?>">
                                             <div style="color: <?=  $banner['pre_title_color']?>" class="banner-type-1__label banner__label"><?= $banner['pre_title']?></div>
                                             <div style="color: <?=  $banner['title_color']?>" class="banner-type-1__title"><?= $banner['title'] ?></div>
                                             <div style="color: <?=  $banner['desc_color']?>" class="banner-type-1__desc"><?= $banner['desc'] ?></div>
                                             <div style="color: <?=  $banner['desc2_color']?>" class="banner-type-1__desc2"><?= $banner['desc2'] ?></div>
                                             <? if($banner['btn_text']){ ?>
                                                 <a target="_blank" class="site-btn banner-type-1__btn <?=$btn_class_random?>" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
                                             <? } ?>
                                         </div>
							     ...
							     <? if($banner['_type'] === 'type-2'):
                                     $btn_class_random = $banner['_type'].'_btn_'.uniqid();
                                     ?>
								     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-2 swiper-slide">
                                         <style>
                                             .<?=$btn_class_random?>{
                                             <?=($banner['btn_text_color']) ? 'color:'.$banner['btn_text_color'].' !important;' : '' ?>
                                             <?=($banner['btn_background_color']) ? 'background:'.$banner['btn_background_color'].' !important;' : '' ?>
									     ...
									     <div class="banner-type-2__content-wrapper">
										     ...
										     <div style="color: <?=  $banner['title_color']?>" class="banner-type-2__title"><span style="color:<?= $banner['pre_title_color'] ?>" class="banner-type-2__pre-title"><?= $banner['pre_title'] ?></span><?= $banner['title'] ?></div>
									     </div>
                                        <? if($banner['btn_text']){ ?>
									     <a target="_blank" class="site-btn banner-type-2__btn <?=$btn_class_random?>" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
                                        <? } ?>
								     </div>
							     <? endif; ?>
                                 <? if($banner['_type'] === 'type-2-1'):
                                     $btn_class_random = $banner['_type'].'_btn_'.uniqid();
                                     ?>
                                     <div style="background: <?=  $banner['background_color']?>; <? if(!empty($banner['border_color'])): ?>border: 1px solid <?= $banner['border_color']; ?><? endif; ?>" class="banner banner-type-2 banner-type-2-1 swiper-slide">
                                         <style>
                                             .<?=$btn_class_random?>{
                                             <?=($banner['btn_text_color']) ? 'color:'.$banner['btn_text_color'].' !important;' : '' ?>
                                             <?=($banner['btn_background_color']) ? 'background:'.$banner['btn_background_color'].' !important;' : '' ?>
                                         ...
                                         <div class="banner-type-2__content-wrapper">
                                             <img alt="img"  class="banner-type-2__img" src="<?= $banner['image']  ?>">
                                             <div style="color: <?=  $banner['title_color']?>" class="banner-type-2__title"><span style="color:<?= $banner['pre_title_color'] ?>" class="banner-type-2__pre-title"><?= $banner['pre_title'] ?></span><?= $banner['title'] ?></div>
                                             <div style="color: <?=  $banner['title_desc_color']?>" class="banner-type-2__title_desc"><?= $banner['title_desc'] ?></div>
							     ...
							     <? if($banner['_type'] === 'type-3'): ?>
								     <div style="background-image: url('<?=  $banner['background_image']?>')" class="banner banner-type-3 swiper-slide">
									     <div style="color: <?=  $banner['title_color']?>" class="banner-type-3__title"><?= $banner['title'] ?></div>
									     <div class="banner-type-3__content-wrapper">
										     <div style="color: <?=  $banner['desc_color']?>" class="banner-type-3__desc"><?= $banner['desc'] ?></div>
										     <? if(!empty($banner['btn_text'])): ?>
										     	<a target="_blank" style="background: <?=  $banner['btn_background_color']?>; color: <?=  $banner['btn_text_color']?>; border-color: <?=  $banner['btn_text_color']?>" class="site-btn banner-type-3__btn" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
										 	 <? endif; ?>
									     </div>
								     </div>
							     <? endif; ?>
							     <? if($banner['_type'] === 'type-4'): ?>
								     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-4 swiper-slide">
									     <div style="color:<?= $banner['label_color'] ?> " class="banner-type-4__label banner__label"><?= $banner['label'] ?></div>
									     <div style="color: <?=  $banner['title_color']?>" class="banner-type-4__title"><span style="color:<?= $banner['pre_title_color'] ?>" class="banner-type-4__pre-title"><?= $banner['pre_title'] ?></span><?= $banner['title'] ?></div>
									     <img alt="img"  class="banner-type-4__img" src="<?= $banner['image']  ?>">
								     </div>
							     <? endif; ?>
							     <? if($banner['_type'] === 'type-5'): ?>
								     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-5 banner-type-5--with-shadow  swiper-slide">
									     <div style="color:<?= $banner['label_color'] ?> " class="banner-type-5__label banner__label"><?= $banner['label'] ?></div>
									     <div style="color: <?=  $banner['title_color']?>" class="banner-type-5__title"><span style="color:<?= $banner['pre_title_color'] ?>" class="banner-type-5__pre-title"><?= $banner['pre_title'] ?></span><?= $banner['title'] ?></div>
									     <img alt="img"  class="banner-type-5__img" src="<?= $banner['image']  ?>">
								     </div>
							     <? endif; ?>
							     <? if($banner['_type'] === 'type-6'): ?>
								     <div style="background: <?=  $banner['background_color']?>" class="banner banner-type-5 swiper-slide">
									     <div style="color:<?= $banner['label_color'] ?> " class="banner-type-5__label banner__label"><?= $banner['label'] ?></div>
									     <div style="color: <?=  $banner['title_color']?>" class="banner-type-5__title banner-type-5__title--big"><span style="color:<?= $banner['pre_title_color'] ?>" class="banner-type-5__pre-title"><?= $banner['pre_title'] ?></span><?= $banner['title'] ?></div>
									     <img alt="img"  class="banner-type-5__img" src="<?= $banner['image']  ?>">
								     </div>
							     <? endif; ?>
							     <? if($banner['_type'] === 'type-7'):
                                     $btn_class_random = $banner['_type'].'_btn_'.uniqid();
                                     ?>
								     <div style="background: <?=  $banner['background_color']?>"  class="banner banner-type-6 swiper-slide">
                                         <style>
                                             .<?=$btn_class_random?>{
                                             <?=($banner['btn_text_color']) ? 'color:'.$banner['btn_text_color'].' !important;' : '' ?>
                                             <?=($banner['btn_background_color']) ? 'background:'.$banner['btn_background_color'].' !important;' : '' ?>
									     ...
									     <div style="color:<?= $banner['label_color'] ?> " class="banner-type-6__label banner__label"><?= $banner['label'] ?></div>
									     <div style="color: <?=  $banner['title_color']?>" class="banner-type-6__title"><?= $banner['title'] ?></div>
									     <img alt="img"  class="banner-type-6__img" src="<?= $banner['image']  ?>">
									     <div style="color: <?=  $banner['desc_color']?>" class="banner-type-6__desc"><?= $banner['desc'] ?></div>
									     <a target="_blank" class="site-btn banner-type-6__btn <?=$btn_class_random?>" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
								     </div>
							     <? endif; ?>
							     <? if($banner['_type'] === 'type-8'): ?>
								     <div style="background: <?=  $banner['background_color']?>"  class="banner banner-type-7 swiper-slide">
									     <div style="color:<?= $banner['label_color'] ?> " class="banner-type-7__label banner__label"><?= $banner['label'] ?></div>
									     <div style="color: <?=  $banner['title_color']?>" class="banner-type-7__title"><?= $banner['title'] ?></div>
									     <div style="color: <?=  $banner['desc_color']?>" class="banner-type-7__desc"><?= $banner['desc'] ?></div>
									     <? if(!empty($banner['btn_text'])): ?>
										     <a target="_blank" style="color: <?=  $banner['btn_text_color']?>;" class="banner-type-7__link" href="<?= $banner['btn_link'] . get_params_string() ?>"><?= $banner['btn_text']?></a>
									     <? endif; ?>
									     <img alt="img"  class="banner-type-7__img" src="<?= $banner['image']  ?>">
								     </div>
							     <? endif; ?>
							     <? if($banner['_type'] === 'type-with-logo'): ?>
								     <a href="<?= $banner['link'] . get_params_string() ?>" style="background: <?=  $banner['background_color']?>"  class="banner banner-type-8 swiper-slide">
									     <img alt="img"  class="banner-type-8__logo" src="<?= $banner['logo']  ?>">
									     <div style="color: <?=  $banner['title_color']?>" class="banner-type-8__title"><?= $banner['title'] ?></div>
									     <div style="color: <?=  $banner['desc_color']?>" class="banner-type-8__desc"><?= $banner['desc'] ?></div>
                             ...
                             <div class="swiper-slide" style="border-radius: 30px; background: <?= $bgd ?>">
                                 <div class="slider-block__slide" style="background: transparent !important;">
                                     <div class="slider-block__left-side">
                                         ...
                                         <a target="_blank" href="<?= $slide['btn_link'] . get_params_string() ?>" class="site-btn slider-block__btn"><?= $slide['btn_text'] ?></a>
                                     </div>
	     ...
	     ->set_render_callback( function ($fields, $attributes, $inner_blocks) {
		     ...
		     <div class="container">
                 <style>
                     ...
                     <?=($fields['btn_text_color']) ? 'color:'.$fields['btn_text_color'].' !important;' : '' ?>
                     <?=($fields['btn_background_color']) ? 'background:'.$fields['btn_background_color'].' !important;' : '' ?>
                     <?=($fields['btn_border_color']) ? 'border-color: '.$fields['btn_border_color'].' !important;' : '' ?>
                     }
                     .<?=$btn_class_in_tabs_random?>:hover{
                     <?=($fields['btn_hover_text_color']) ? 'color:'.$fields['btn_hover_text_color'].' !important;' : '' ?>
                     <?=($fields['btn_hover_background_color']) ? 'background:'.$fields['btn_hover_background_color'].' !important;' : '' ?>
                     <?=($fields['btn_hover_border_color']) ? 'border-color: '.$fields['btn_hover_border_color'].' !important;' : '' ?>
                     }
                 </style>
			     <div
				     <? if(!empty($id)): ?>
				     ...
				     <div class="swiper-container tabs-nav tabs-nav--slider">
					     <div class="swiper-wrapper">
						     <? foreach($tabs as $tab): ?>
							     <div class="swiper-slide" <? if(sizeof($tabs) < 3):?>style="min-width: 49%;"<? endif; ?>>
								     ...
								     <div class="tabs-content__item">
									     <div class="tabs-content__left-side">
                                             ...
                                             <? if( !empty($tab['btn_text']) ) { ?>
										        <a target="_blank" href="<?= $tab['btn_link'] ?>" class="site-btn tabs-content__btn <?=$btn_class_in_tabs_random?>"><?= $tab['btn_text'] ?></a>
                                             <? } ?>
									     </div>
							...
							<div style="display:none" class="swiper-container tabs-nav">
								<div class="swiper-wrapper">
									<? foreach($item['tabs'] as $tab): ?>
										<div class="swiper-slide" <? if(sizeof($item['tabs']) < 3):?>style="min-width: 49%;"<? endif; ?>>
										<div class="tabs-nav__text"><?= $tab['title'] ?></div>
										</div>
									<? endforeach; ?>
								</div>
								...
								<div class="swiper-wrapper">
									<? foreach($item['tabs'] as $tab): ?>
										<div class="swiper-slide">
											<div class="tabs-content__item">
												<div class="tabs-content__left-side">
													<div style="color: <?= $tab['title_text_color'] ?>" class="tabs-content__title"><?= $tab['title'] ?></div>
													<div class="tabs-content__desc"><?= $tab['desc'] ?></div>
																							<? if( !empty($tab['btn_text']) ) { ?>
														<a itemscope itemtype="https://schema.org/Action"
                                                           itemprop="potentialAction"
                                                           itemref="target" target="_blank" href="<?= $tab['btn_link'] . get_params_string() ?>" class="site-btn tabs-content__btn <?=$btn_class_in_tabs_random?>"><?= $tab['btn_text'] ?></a>
                                                                                                <meta itemprop="target" content="<?= $tab['btn_link'] . get_params_string() ?>">
																							<? } ?>
												</div>
												<div class="tabs-content__right-side">
    												...
    												<? if(!empty($tab['image'] and !empty($tab['image_after']))): ?>
    											        <div class="image-compare">
    											            <img class="not-lazy" loading="lazy" alt="" src="<?= $tab['image'] ?> itemscope itemtype="https://schema.org/ImageObject"">
    											            <img style="width:auto;" class="not-lazy" loading="lazy" alt="" src="<?= $tab['image_after'] ?> itemscope itemtype="https://schema.org/ImageObject"">
    											        </div>
    												<? endif; ?>
												</div>
											</div>
							     ...
							     <? foreach($testimonials as $testimonial): ?>
								     <div class="swiper-slide testimonials-block__slide">
									     <? if(!empty($testimonial['brand_logo'])): ?>
										     <img alt="img"  src="<?= $testimonial['brand_logo'] ?>" class="testimonials-block__slide-logo">
									     <? endif; ?>
									     ...
									     <div class="testimonials-block__slide-client-info">
										     <? if(!empty($testimonial['client_avatar'])): ?>
											     <img alt="img"  class="testimonials-block__slide-client-avatar" src="<?= $testimonial['client_avatar'] ?>">
										     <? endif; ?>
					     ...
					     <div class="swiper-container  new-testimonials-block__slider">
						     <div class="swiper-wrapper">
								...
								<?  $background = $testimonial['background_color']; ?>                                            
								     ...
								     <div itemprop="review" itemscope itemtype="https://schema.org/Review" <? if(!empty($background)): ?>
										     style="background:<?= $background ?>"
				     ...
				     <div
					     ...
					     <div class="products-slider-block__content-wrapper">
						     ...
						     <? if($products_slider_title): ?>
							     <div style="max-width: <?= $products_slider_title_max_width ?>" class="products-slider-block__title"><?= $products_slider_title ?></div>
						     <? endif; ?>
						     <? if(!empty($products_slider_btn_text) and !empty($products_slider_btn_link)): ?>
							     <a href="<?= $products_slider_btn_link . get_params_string() ?>" class="site-btn products-slider-block__btn"><?= $products_slider_btn_text ?></a>
						     <? endif; ?>
					     </div>
						     ...
						     <div class="swiper-wrapper">
							     <? foreach($products as $product): ?>
								     ...
								     <a
									     ...
									     <img alt="img"  class="products-slider-block__slide-logo" src="<?= $product['logo'] ?>">
	     ...
	     ->set_render_callback( function ($fields, $attributes, $inner_blocks) {
		     ...
		     <div class="container">
			     <div
				     ...
				     <form data-succsess-text="<?= $contact_form_success_msg ?>" data-error-text="<?= $contact_form_error_msg ?>" class="contact-form-block__form gform">
					     <div class="contact-form-block__left-side">
						     ...
						     <input type="tel" name="phone" placeholder="Phone Number" pattern="(\+?\d[- .]*){7,13}" required autocomplete="off">
					     </div>
					     <div class="contact-form-block__right-side">
						     ...
						     <input type="hidden" name="type-request" value="Заявка">
						     <input type="hidden" name="action" value="contact_form">
						     <button class="site-btn contact-form-block__form-btn" type="submit"><?= $btn_text ?></button>
					     </div>
					     <div class="contact-form-block__form-status"></div>
				     </form>
			     ...
			     <div class="container">
				     <div
					     ...
					     <div class="swiper-container tabs-2-nav">
						     <div class="swiper-wrapper">
							     <? foreach($tabs as $tab): ?>
								     <div class="swiper-slide"><div class="tabs-nav__text"><?= $tab['title'] ?></div></div>
							     <? endforeach; ?>
						     </div>
					     </div>
				     ...
				     <div
					     ...
					     class="block <?= $margin_mode ?> content-tabs-block">
							     ...
							     <div class="swiper-slide before-after-block">
    								...
    								<a href="<?= $btn_link ?>" target="_blank" class="site-btn before-after-content__btn"><?= $btn_text ?></a>
    								<? endif; ?>    								
                                    </div>
							         <div class="before-after__content-wrapper">
							             ...
							             <div class="image-compare">
                                            <? if(!empty($image_after)): ?>
                                                ...
                                                <img loading="lazy" width="1050" height="700" alt="img"  class="before-after__img not-lazy" src="<?= $image_after ?>">
                                            <? endif; ?>
                                            <? if(!empty($image_before)): ?>
                                                <?$image_before = ImageResizeWordPress::resizeWidthWebp($image_before, 1450) ?>
                                                <img loading="lazy" width="1050" height="700" alt="img"  class="before-after__img not-lazy" src="<?= $image_before ?>">
                                            <? endif; ?>
                                        </div>
                                        <? endif; ?><div class="bottom-left"><?= $before_text ?></div><div class="bottom-right"><?= $after_text?></div></div>
                                    </div>
							     </div>
							     </div> </div>
		     <?
							     ...
							     <div class="swiper-slide tabs-1-block">
									...
									<div class="tabs-content__item chess-content__item">
												<div class=" chess-content-left-size">
													<div  class="chess-content__title" itemprop="name"><?= $fields['left-chess-title1'] ?></div>
													<div class="chess-content__desc" itemprop="description"><?= $fields['left-desc1'] ?></div>
													<aitemscope="" itemtype="https://schema.org/Action" itemprop="potentialAction" itemref="target" target="_blank" href="<?= $fields['chess-btn_link']?>" class="site-btn chess-content__btn"><?= $fields['chess-btn_text'] ?></a>
												</div>
												<div class="chess-content-right-size" itemscope itemtype="https://schema.org/ImageObject">
									...
									<div class="tabs-content__item chess-content__item">
												...
												<div class=" chess-content-left-size">
													<div  class="chess-content__title" itemprop="name"><?= $fields['right-chess-title1'] ?></div>
													<div class="chess-content__desc" itemprop="description"><?= $fields['right-desc1'] ?></div>
													<a itemscope="" itemtype="https://schema.org/Action" itemprop="potentialAction" itemref="target"  target="_blank" href="<?= $fields['chess-btn_link']?>" class="site-btn chess-content__btn"><?= $fields['chess-btn_text'] ?></a>
												</div>
									</div> 
									<div class="tabs-content__item chess-content__item">
												<div class=" chess-content-left-size">
													<div  class="chess-content__title"  itemprop="name"><?= $fields['left-chess-title2'] ?></div>
													<div class="chess-content__desc" itemprop="description"><?= $fields['left-desc2'] ?></div>
													<a itemscope="" itemtype="https://schema.org/Action" itemprop="potentialAction" itemref="target"  target="_blank" href="<?= $fields['chess-btn_link']?>" class="site-btn chess-content__btn"><?= $fields['chess-btn_text'] ?></a>
												</div>
												<div class="chess-content-right-size" itemscope itemtype="https://schema.org/ImageObject">
									...
									<div class="tabs-content__item chess-content__item">
												...
												<div class=" chess-content-left-size">
													<div  class="chess-content__title"  itemprop="name"><?= $fields['right-chess-title2'] ?></div>
													<div class="chess-content__desc" itemprop="description"><?= $fields['right-desc2'] ?></div>
													<a itemscope="" itemtype="https://schema.org/Action" itemprop="potentialAction" itemref="target"  target="_blank" href="<?= $fields['chess-btn_link']?>" class="site-btn chess-content__btn"><?= $fields['chess-btn_text'] ?></a>
												</div>
									</div>
									</div>
                    ...
                    <div <? if(!empty($id)): ?>
                        ...
                        <? foreach ($categories as $category): ?>
                            <div class="tools_category_class">
                                <a class="tools_link" href="#<?= $category['anchor_id']?>"><?= $category['title'] ?></a>
                            </div>  
                            <? endforeach; ?>
                        </div>    
                        </div>
                            ...
                            <div id="<?= $category['anchor_id']?>">
                                ...
                                <div class="resources-grid-wrapper">
                                    ...
                                    <div class="tools_list_item">
                                        <a href="<?= $tool['link']?>" target="_blank" class="resource-tile-container">
                                            ...
                                            <span class="resource-tag" style="color:<?= $tool['text_color']?>; background-color:<?= $tool['background_color']?>">
                                                <?= $tool['is_free']?>
                                            </span>
                                            </div>
                                        </a>
						     ...
						     <div class="swiper-wrapper">
							     <? foreach($tabs as $tab): ?>
								     <div class="swiper-slide">
								         <div class="tabs-nav__text">
								             <? if(!empty($tab['icon'])): ?>
								             <img style="margin-right: 15px;" src="<?= $tab['icon'] ?>" alt="<?= $tab['title'] ?>">
								             <? endif; ?>
								             <?= $tab['title'] ?>
								        </div>
								    </div>
					     ...
					     <div class="swiper-container content-tabs-content">
						     <div class="swiper-wrapper">
						         <? if($fields['content_tabs_type'] == 'video'): ?>
    							     ...
    							     ?>
    								     <div class="swiper-slide">
        								     <iframe style="aspect-ratio: 16 / 9;width: 100%;z-index:999;" class="youtube-video" src="//www.youtube.com/embed/<?= $query['v'] ?>??html5=1&enablejsapi=1&rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    								     </div>
    							     <? endforeach; ?>
							     <? endif; ?>
							     <? if($fields['content_tabs_type'] == 'image-compare'): ?>
							     ...
							     <div class="swiper-slide" itemtype="https://schema.org/Product">
							         <div class="gallery-block__content-wrapper">
							             ...
							             <div class="image-compare">
                                            <? if(!empty($image_after)): ?>
                                                <?$image_after = ImageResizeWordPress::resizeWidthWebp($image_after, 1450) ?>
                                                <img loading="lazy" width="1050" height="700" alt="img"  class="gallery-block__img not-lazy" src="<?= $image_after ?>">
                                            <? endif; ?>
                                            <? if(!empty($image_before)): ?>
                                                <?$image_before = ImageResizeWordPress::resizeWidthWebp($image_before, 1450) ?>
                                                <img loading="lazy" width="1050" height="700" alt="img"  class="gallery-block__img not-lazy" src="<?= $image_before ?>">
                                            <? endif; ?>
                                        </div>
                                        <? endif; ?>
                                    </div>
    								...
    								<? if(!empty($btn_text) and !empty($btn_link)): ?>
    								<a itemscope="" itemtype="https://schema.org/Action" itemprop="potentialAction" itemref="target"  href="<?= $btn_link ?>" target="_blank" class="site-btn content-tabs-content__btn <?= $tab_btn_add_class ?>"><?= $btn_text ?></a>
    								<? endif; ?>
							     </div>
							     <? endforeach; ?>
							     <? endif; ?>
...
?>
                ...
                <div class="filter--btns">
                    <div class="swiper-wrapper media__tabs--btns">
                        <div class="swiper-slide fit-content">
                            ...
                            <button type="button" class="media__tabs-btn active" data-filter="all"><?= $all_posts_label ?></button>
                            <? endif; ?>
                        </div>
                        <?php foreach ($terms as $category) :?>
                            <div class="swiper-slide fit-content">
                                <button type="button" class="media__tabs-btn" data-filter="<?= $category->slug; ?>">
                                    <?= $category->name; ?>
                                </button>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <div class="media__blog--slider media--tabs__slider">
                            <div class="swiper-wrapper">
                                <?php if ($postsTab->have_posts()) : ?>
                                    <?php while ($postsTab->have_posts()):$postsTab->the_post();
                                        ...
                                        if ($type_card == 'card_news') {
                                            ...
                                            if(!empty($blog_image)) {
                                                $blog_image = ImageResizeWordPress::resizeWidthWebp($blog_image, 500);
                                            }
                                        } elseif ($type_card == 'card_blog') {
                                            $dataNews = "blog";
                                            $blog_image = wp_get_attachment_image_url($preview_blog_card, 'full');
                                            if(!empty($blog_image)) {
                                                $blog_image = ImageResizeWordPress::resizeWidthWebp($blog_image, 500);
                                            }
                                        } elseif ($type_card == 'card_press') {
                                            $dataNews = "press";
                                            $blog_image = wp_get_attachment_image_url($brandImg, 'full');
                                            if(!empty($blog_image)) {
                                                $blog_image = ImageResizeWordPress::resizeWidthWebp($blog_image, 360);
                                            }
                                        }
                                        ?>
                                        ...
                                        <?php if (!empty($dataNews)): ?>
                                            <div class="tab  swiper-slide mw360" data-filter="<?= $dataNews ?>">
                                                <div class="page__blog--item__content media__blog--item blog__block p32" style="background: url('<?= $blog_image ?>') center no-repeat; background-size: cover;">
                                                    <div>
		     ...
		     <section
			     ...
			     <div class="container">
				     <div class="team-section__content-wrapper relative">
					     ...
					     <a target="_blank" href="<?= $fields['team_section_btn_link'] . get_params_string() ?>" class="site-btn team-section__btn mb160"><?= $fields['team_section_btn_text'] ?></a>
				     </div>
    ...
    Block::make( 'Popup Bunner')
        ...
        ->set_render_callback( function ($fields, $attributes, $inner_blocks) {
            ...
            <a href="<?=$fields['popup_banner_btn_link']; ?>" class="popup_banner_wrapper" style="background:<?=$fields['popup_bunner_css_background']; ?>">
                ...
                <div class="popup_modal_content" style="background:<?=$fields['popup_bunner_css_background']; ?>">
                    ...
                    <div class="popup_modal_inner">
                        ...
                        <div class="popup_modal_bottom">
                            ...
                            <div class="popup_modal_text" style="color:<?=$fields['popup_banner_modal_color3']; ?>"><?=$fields['popup_banner_modal_text3']; ?>
                     ...
                     <div class="container">
                         <div class="tabs__inner">
                             ...
                             <div class="tabs__item sm">
                                 ...
                                 <a href="<?=$fields['al_one_tab-link'] . get_params_string() ?>" class="tabs__btn"><?=$fields['al_one_tab-link_text']; ?>
						...
						<div class="swiper-container grid-content__slider">
							<div class="swiper-wrapper">
								<? foreach($images as $image): ?>
									<div class="swiper-slide">
										<img alt="img"  src="<?= $image['image'] ?>" <? if($image['border'] == 'yes'): ?> style="border: 1px solid #acacac" <? endif; ?>>
									</div>
								<? endforeach; ?>
							</div>
		    ...
		    <div class="container-big">
				...
				>	        
						...
						<?
									...
									?>
					    <div class="question-card"  style="<?if(!empty($background)): ?>background:<?= $background ?>;<?endif;?>" >

											<button class="questions_question" style="color: <?= $question['text_color']; ?>" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"><p itemprop="name"><?= $question['question'] ?></p><span class="questions_arrow"><i class="fa-solid fa-chevron-up"></i></span></button>
                            <div class="questions_answer" temscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" style="display: none ;color: <?= $question['text_color']; ?>"><meta itemprop="text"><?= $question['answer'] ?>     </div>
		...
		->set_render_callback( function ($fields, $attributes, $inner_blocks) {
		    ...
		    <? if(!empty($products)):
			    ...
			    <div class="container-big">
                    <style>
                        .<?=$btn_class_random?>{
                        <?=($fields['row3_slider_btn_text_color']) ? 'color:'.$fields['row3_slider_btn_text_color'].' !important;' : '' ?>
                        <?=($fields['row3_slider_btn_background_color']) ? 'background:'.$fields['row3_slider_btn_background_color'].' !important;' : '' ?>
                        <?=($fields['row3_slider_btn_border_color']) ? 'border-color: '.$fields['row3_slider_btn_border_color'].' !important;' : '' ?>
                        }
                        .<?=$btn_class_random?>:hover{
                        <?=($fields['row3_slider_btn_text_color_hover']) ? 'color:'.$fields['row3_slider_btn_text_color_hover'].' !important;' : '' ?>
                        <?=($fields['row3_slider_btn_background_color_hover']) ? 'background:'.$fields['row3_slider_btn_background_color_hover'].' !important;' : '' ?>
                        <?=($fields['row3_slider_btn_border_color_hover']) ? 'border-color: '.$fields['row3_slider_btn_border_color_hover'].' !important;' : '' ?>
                        }
                    </style>
				    <div 
				     	<? if(!empty($id)): ?>id="<?= $id ?>"<? endif; ?> 
				    ...
				    >
					    ...
					    <div class="products-slider-block__content-wrapper">
						    <? if($row3_slider_title): ?>
							    <div style="color: <?= $row3_slider_title_color ?>; padding-bottom: 0;" class="products-slider-block__title"><?= $row3_slider_title ?></div>
						    <? endif; ?>
						    <? if($row3_slider_description): ?>
							    <div style="color: <?= $row3_slider_description_color ?>; padding-bottom: 0;" class="products-slider-block__description"><?= $row3_slider_description ?></div>
						    <? endif; ?>
					    </div>
					    ...
					    <div class="swiper-container products-slider-block__slider" id="row3-slider">
							<div class="swiper-wrapper">
								<? foreach($products as $product): ?>
									...
									?>
									<div style="background:<?= $background ?>; <?if(!empty($border)): ?> border: 1px solid <?= $border; ?>; <?endif;?>" class="swiper-slide products-slider-block__slide" >
										<div class="block_title">
											<img alt="img"  class="products-slider-block__slide-logo" src="<?= $product['logo'] ?>">
											<div class="products-slider-block__slide-title" style="color: <?= $product['text_color']; ?>"><?= $product['title'] ?></div>
										</div>
										<div class="products-slider-block__slide-desc" style="color: <?= $product['text_color']; ?>"><?= $product['desc'] ?></div>
									</div>
								<? endforeach; ?>
							</div>
							<div class="swiper-pagination products-slider-block__slider-pagination"></div>
				    ...
				    >
					    ...
					    <div class="speakers-slider-block__content-wrapper">
						    <? if($speakers_block_title): ?>
							    <div style="color: <?= $speakers_block_title_color ?>;" class="speakers-slider-block__title"><?= $speakers_block_title ?></div>
						    <? endif; ?>
						    <? if($speakers_block_description): ?>
							    <div style="color: <?= $speakers_block_description_color ?>;" class="speakers-slider-block__description"><?= $speakers_block_description ?></div>
						    <? endif; ?>
					    </div>
					    ...
					    <div class="swiper-container speakers-slider-block__slider <?= $speakers_slider_add_class ?>">
							<div class="swiper-wrapper">
								<? foreach($speakers as $speaker): ?>
									...
									?>
									<div style="background:<?= $background ?>; <?if(!empty($border)): ?> border: 2px solid <?= $border; ?>; <?endif;?>" class="swiper-slide speakers-slider-block__slide" >
    									<img alt="<?= $speaker['title'] ?>"  class="speakers-slider-block__speaker-img" src="<?= $speaker['image'] ?>">
    									<div class="speakers-slider-block__speaker-title" style="color: <?= $speaker['text_color']; ?>"><?= $speaker['title'] ?></div>
    									<div class="speakers-slider-block__speaker-position" style="color: <?= $speaker['text_color']; ?>"><?= $speaker['position'] ?></div>
    									<div class="speakers-slider-block__speaker-desc" style="color: <?= $speaker['text_color']; ?>"><?= $speaker['desc'] ?></div>
    									<img class="speakers-slider-block__speaker-company-logo" src="<?= $speaker['logo'] ?>">
									</div>
								<? endforeach; ?>
									...
									<div class="swiper-slide speakers-slider-block__slide speakers-slider-block__slide--blank" >
									    <div class="speakers-slider-block__blank-photo">
									        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="23.2227" y="49.8889" width="49.7778" height="3.55556" rx="1.77778" transform="rotate(-90 23.2227 49.8889)" fill="#151516"/>
                                                <rect x="0.111328" y="23.2222" width="49.7778" height="3.55556" rx="1.77778" fill="#151516"/>
                                            </svg>
									    </div>
		    ...
		    <div class="container-big tabs-1-block" >
		      <div class="tabs-content__item">
                  <div class="tabs-content__left-side" style="color: #000; order: 2;">
                    ...
                    <div class="speakers-info">
                        <img style="border-radius: 0px" width="70" height="70" class="speakers-info__img" src="<?= $meetup_calendar_img ?>" alt="">
                        <? foreach($meetup_speakers as $speaker): ?>
                        <img width="70" height="70" class="speakers-info__img" src="<?= $speaker['image'] ?>" alt="">
                        <? endforeach; ?>
<!--                         <div class="speakers-info__blank-card">
    <svg width="20" height="20" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="23.2227" y="49.8889" width="49.7778" height="3.55556" rx="1.77778" transform="rotate(-90 23.2227 49.8889)" fill="#151516"></rect>
        <rect x="0.111328" y="23.2222" width="49.7778" height="3.55556" rx="1.77778" fill="#151516"></rect>
                    ...
                    <a style="background-color:#FECE33; border-color:#FECE33;" href="<?= $meetup_page_link ?>" class="site-btn tabs-content__btn"><?= $meetup_button_text ?></a>
                  </div>
		...
		->set_render_callback( function ($fields, $attributes, $inner_blocks) {
		    ...
		    <? $btn_class_random = 'gallery_block_btn_'.uniqid(); ?>
			    <div class="container-big">
                    <style>
                        .<?=$btn_class_random?>{
                        <?=($fields['gallery_block_btn_text_color']) ? 'color:'.$fields['gallery_block_btn_text_color'].' !important;' : '' ?>
                        <?=($fields['gallery_block_btn_background_color']) ? 'background:'.$fields['gallery_block_btn_background_color'].' !important;' : '' ?>
                        <?=($fields['gallery_block_btn_border_color']) ? 'border-color: '.$fields['gallery_block_btn_border_color'].' !important;' : '' ?>
                        }
                        .<?=$btn_class_random?>:hover{
                        <?=($fields['gallery_block_btn_text_color_hover']) ? 'color:'.$fields['gallery_block_btn_text_color_hover'].' !important;' : '' ?>
                        <?=($fields['gallery_block_btn_background_color_hover']) ? 'background:'.$fields['gallery_block_btn_background_color_hover'].' !important;' : '' ?>
                        <?=($fields['gallery_block_btn_border_color_hover']) ? 'border-color: '.$fields['gallery_block_btn_border_color_hover'].' !important;' : '' ?>
                        }
                    </style>
				    <div 
				     	<? if(!empty($id)): ?>id="<?= $id ?>"<? endif; ?> 
											...
											<div class="swiper-slide gallery-block_slide">
                        						<div class="gallery-block__content-wrapper">
                        						    <? if($gallery_block_title): ?>
                        							    <div style="color: <?= $gallery_block_title_color ?>;" class="gallery-block__title"><?= $gallery_block_title ?></div>
                        						    <? endif; ?>
                        						    <? if($gallery_block_description): ?>
                        							    <div style="color: <?= $gallery_block_description_color ?>;" class="gallery-block__description"><?= $gallery_block_description ?></div>
                        						    <? endif; ?>
                        								<? if(!empty($gallery_block_btn_text) and !empty($gallery_block_btn_link)): ?>
                        							    <a target="_blank" href="<?= $gallery_block_btn_link . get_params_string() ?>" class="site-btn gallery-block__btn <?=$btn_class_random?>"><?= $gallery_block_btn_text ?></a>
                        								<? endif; ?>
    											<?
    											if($gallery_slide_type == 'image' and !empty($gallery_slide_img)){
        											...
        											?>
        												<img class="not-lazy" width="1050" height="700" alt="img"  class="h__img gallery-block__img" src="<?= $slide_image ?>">
        											<?
        											$image_resize_url = ImageResizeWordPress::resizeWidthWebp($gallery_slide_img, 768);
        											?>
        											    <img class="not-lazy" width="768" height="400" alt="img" class="h__img h__img_mobile gallery-block__img" src="<?= $image_resize_url ?>" >
        											<?
    											}
    											if($gallery_slide_type == 'video' and !empty($gallery_slide_img)){?>
    											    <video autoplay loop muted playsinline class="gallery-block__img gallery-block__video">
                                                ...
                                                parse_str($parts['query'], $query);
    											?>
    											    <iframe style="aspect-ratio: 16 / 9;width: 95%;z-index:999;" class="youtube-video" src="//www.youtube.com/embed/<?= $query['v'] ?>?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                <?
    											}
    	                                        ?>
    											</div>
    											<div class="gallery-block__columns">
    											    <div style="color: <?= $gallery_block_left_column_text_color ?>;" class="gallery-block__column-left gallery-block__column-desc"><?= $gallery_slide_left_content ?></div>
    											    <div style="color: <?= $gallery_block_right_column_text_color ?>;" class="gallery-block__column-right gallery-block__column-desc"><?= $gallery_slide_right_content ?></div>
    											</div>
											</div>
										<? endforeach; ?>
									</div>
    			...
    			<div <? if(!empty($id)): ?>id="<?= $id ?>"<? endif; ?> class="block <?= $margin_mode ?> irtc-block">
                    <div class="irtc-block__wrapper"  itemprop="description">
                        <div class="irtc-block__left-side">
                            <img class="irtc-block__img" src="<?= wp_get_attachment_image_url( $image, 'full' ) ?>" alt="">
                        </div>
                    ...
                    <a target="_blank" class="site-btn irtc-block__btn" href="<?= $irtc_btn_link ?>"><?= $irtc_btn_text ?></a>
    			</div>
		    </div>
		    <?
		}
							...
							<div class="swiper-wrapper">
								<? foreach($cards as $card): ?>
									<div class="swiper-slide card-1-row-5-column_slide"  <? if($fields['border'] == 'yes'): ?> style="border: 1px solid #666;border-radius: 15px;" <? endif; ?>>
										<div class="card-1-row-5-column_slide-text" style="color: <?= $card['text_color']; ?>"><?= $card['card_text'] ?></div>
									</div>
								<? endforeach; ?>
							</div>
						...
						<div class="card-1-row-5-column_cta" style="background:<?= $fields['cta_bg_color'] ?>">
						    <div class="card-1-row-5-column_cta-profile">
						        ...
						        <img class="card-1-row-5-column_avatar" src="<?= $fields['card_avatar'] ?>">
			                     <? endif; ?>
						        <div>
						            <div class="card-1-row-5-column_card-name" style="color: <?= $fields['card_text_color']; ?>"><?= $fields['card_name'] ?></div>
						            <div class="card-1-row-5-column_card-job" style="color: <?= $fields['card_text_color']; ?>"><?= $fields['card_job'] ?></div>
						        </div>
						    </div>
						    <a href="<?= $fields['card_btn_link'] ?>" style="color:<?= $fields['card_btn_text_color'] ?>">
						        <div class="card-1-row-5-column_cta-button" style="background:<?= $fields['card_btn_bg_color'] ?>">
						        <?= $fields['card_btn_text'] ?><img src="/wp-content/themes/orm/img/Arrow 1.svg" alt="Arrow"/>
						    </div>
						    </a>
						</div>
				    </div>
		...
		->set_render_callback( function ($fields, $attributes, $inner_blocks) {
		    ...
		    <? if(!empty($products)):
			    ...
			    <div class="container-big" itemscope itemtype="https://schema.org/HowTo">
                    <style>
                        .<?=$btn_class_random?>{
                        <?=($fields['row3_slider_step_btn_text_color']) ? 'color:'.$fields['row3_slider_step_btn_text_color'].' !important;' : '' ?>
                        <?=($fields['row3_slider_step_btn_background_color']) ? 'background:'.$fields['row3_slider_step_btn_background_color'].' !important;' : '' ?>
                        <?=($fields['row3_slider_step_btn_border_color']) ? 'border-color: '.$fields['row3_slider_step_btn_border_color'].' !important;' : '' ?>
                        }
                        .<?=$btn_class_random?>:hover{
                        <?=($fields['row3_slider_step_btn_text_color_hover']) ? 'color:'.$fields['row3_slider_step_btn_text_color_hover'].' !important;' : '' ?>
                        <?=($fields['row3_slider_step_btn_background_color_hover']) ? 'background:'.$fields['row3_slider_step_btn_background_color_hover'].' !important;' : '' ?>
				    ...
				    >
					    ...
					    <div class="products-slider-block__content-wrapper row3-step-slider-block__content-wrapper">
						    <? if($row3_slider_step_title): ?>
							    <div style="color: <?= $row3_slider_step_title_color ?>; padding-bottom: 0;" class="products-slider-block__title"><?= $row3_slider_step_title ?></div>
						    <? endif; ?>
						    <? if($row3_slider_step_description): ?>
							    <div style="color: <?= $row3_slider_step_description_color ?>; padding-bottom: 0;" class="products-slider-block__description"><?= $row3_slider_step_description ?></div>
						    <? endif; ?>
					    </div>
							...
							<div class="swiper-wrapper">
								<? $i=0; foreach($products as $product): ?>
									<?
										...
										$border = $product['border_color'];
									?>
                                    <meta itemprop="position" content="<? $i++; echo $i ?>"/>
									<div style="background:<?= $background ?>; <?if(!empty($border)): ?> border: 1px solid <?= $border; ?>; <?endif;?>" class="swiper-slide products-slider-block__slide row3-step-slider-block__slide" itemprop="step" itemscope itemtype="https://schema.org/HowToSection">
										<div class="block_title" >
											<div  class="row3-step-slider-block__step-text" style="background: <?= $product['step_bg_color'] ?>; color: <?= $product['step-text_color'] ?>"><?= $product['step_text']?></div>
											<img alt="img"  class="products-slider-block__slide-logo" src="<?= $product['logo'] ?>">
											<div  itemprop="name" class="products-slider-block__slide-title row3-step-slider-block__slide-title" style="color: <?= $product['text_color']; ?>"><?= $product['title'] ?></div>
										</div>
										<div  itemprop="text" class="products-slider-block__slide-desc row3-step-slider-block__slide-desc" style="color: <?= $product['text_color']; ?>"><?= $product['desc'] ?></div>
									</div>
								<? endforeach; ?>
							</div>
					    ...
					    <? if(!empty($row3_slider_step_btn_text) and !empty($row3_slider_step_btn_link)): ?>
							<div class="products-slider-block__content-wrapper" style="padding-top: 60px;">
							    <a class="site-btn products-slider-block__btn <?=$btn_class_random?>" href="<?=$row3_slider_step_btn_link?>">
			    ...
			    <div class="container">
					...
					>
						<div class="swiper-container grid-mobile1-content__slider">
							<div class="swiper-wrapper">
								<? foreach($images as $image): ?>
									    <div class="swiper-slide grid-mobile1-content__slide"   style="<? if($fields['border'] == 'yes'): ?>border: 1px solid #666;border-radius: 15px<? else :?>border-radius: 6px<?endif ?>; background: <?= $image['background_color']; ?>;" >
									        <div class="block_title grid-mobile1-content__slide-header-block">
									            <img class="products-slider-block__slide-logo" alt="img"  src="<?= $image['image'] ?>">
										    	<div class="grid-mobile1-content__slide-title" style="color: <?= $image['title_color']; ?>"><?= $image['title'] ?></div>
									    	</div>
									    <div class="grid-mobile1-content__slide-desc" style="color: <?= $image['desc_color']; ?>"><?= $image['desc'] ?></div>
									</div>
								<? endforeach; ?>
							</div>
                            ...
                            <div class="tools-page">	
								<? foreach($tools as $tool): ?>
									    ...
									    <a class="tools-grid-content__slide" href="<?= $tool['tool-link']; ?>">
									        ...
									        <div class="block_title tools-grid-content__slide-header-block">
									            <img class="tools-grid__slide-icon" alt="img"  src="<?= $tool['image'] ?>">
										    	<div class="tools-grid-content__slide-title" style="color: <?= $tool['title_color']; ?>"><?= $tool['title'] ?></div>
									    	</div>
									    <div class="tools-grid-content__slide-desc" style="color: <?= $tool['desc_color']; ?>"><?= $tool['desc'] ?></div>
									</a>
									</div>
								<? endforeach; ?>
						</div>
						...
						<div class="swiper-container tools-grid2-content__slider">
							<div class="swiper-wrapper">
								<? foreach($toolslower as $toollower): ?>
									        <div class="swiper-slide"   style="<? if($fields['border'] == 'yes'): ?>border: 1px solid #666;border-radius: 15px<? else :?>border-radius: 6px<?endif ?>; background: <?= $toollower['background_color']; ?>;" >
									    <a class="tools-grid2-content__slide" href="<?= $toollower['tool-link']; ?>">

									        <div class="block_title tools-grid2-content__slide-header-block">
									            <img class="tools-grid2__slide-icon" alt="img"  src="<?= $toollower['image'] ?>">
										    	<div class="tools-grid2-content__slide-title" style="color: <?= $toollower['title_color']; ?>"><?= $toollower['title'] ?></div>
									    	</div>
									    </a>
